...
def main():
    ...
    st.set_page_config(page_title="사회", page_icon="🌻", layout="centered")  # 레이아웃을 설정하여 폰트 경고를 방지
    st.image('world.png')  # 상단에 이미지를 표시
    st.title("_:blue[2. 지구촌의 평화와 발전 도우미]_ 🏫")  # 제목 표시 (사회 학습 도우미)
